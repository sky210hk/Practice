        ...
        <div class="container" style="margin-top: 5%;">
            <div class="row">
                <form action = "regist.bbs" method = "post">
                    ...
                    <input type="button" class="btn btn-primary pull-left" value="목록" onclick="location.href='board.bbs'">
                    <input type="submit" class="btn btn-primary pull-right" value="작성 완료" onclick="">
